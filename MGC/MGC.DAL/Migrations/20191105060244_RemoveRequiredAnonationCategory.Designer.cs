...
namespace MGC.DAL.Migrations
{
    ...
    [Migration("20191105060244_RemoveRequiredAnonationCategory")]
    partial class RemoveRequiredAnonationCategory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MGC.ENTITY.MTableRecord.FilterRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("IncludedTableType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("FilterRecord");
                });

            modelBuilder.Entity("MGC.ENTITY.MTableRecord.ProductRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MGC.ENTITY.MTableRecord.TablelessFilterProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TablelessFilterProperty");
                });
            ...
            modelBuilder.Entity("MGC.ENTITY.MTableRecord.FilterRecord", b =>
                {
                    b.HasOne("MGC.ENTITY.MTableRecord.ProductRecord", "ProductRecord")
                        .WithMany("FilterRecords")
            ...
            modelBuilder.Entity("MGC.ENTITY.MTableRecord.ProductRecord", b =>
                {
                    b.HasOne("MGC.ENTITY.MCategory.Category", "Category")
                        .WithMany()
